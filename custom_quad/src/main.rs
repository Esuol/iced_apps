...
impl Example {
    ...
    fn update(&mut self, message: Message) {
        ...
        match message {
            ...
            Message::ShadowBlurRadiusChanged(radius) => {
                self.shadow.blur_radius = radius;
            }
        }
    }
    ...
    fn view(&self) -> Element<Message> {
        ...
        let content = column![
            quad::CustomQuad::new(200.0, self.radius, self.border_width, self.shadow),
...
fn main() -> iced::Result {
    iced::run("custon Quad", Example::update, Example::view)
}
